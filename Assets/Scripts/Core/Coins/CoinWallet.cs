...
public class CoinWallet : NetworkBehaviour
{
    ...
    [SerializeField]
    private float bountyPercentage = 50f;
    //[SerializeField]
    ...
    private void HandleDie(Health health)
    {
        ...
        //int bountyCoinValue = bountyValue / bountyCoinCount; // minimum coin value

        //Debug.Log(bountyCoinValue);

        //if (bountyCoinValue < minBountyCoinValue) { return; }

        int bountyCoinCount = bountyValue / coinValue;
